...
- **`web-vitals` no longer throws on Chrome < 92 WebViews.** web-vitals 5
  ...
  on every layout shift, for the life of the page, filed by our own error
  tracker as an application error. CLS and INP are now registered only where
  `Array.prototype.at` exists; LCP, FCP and TTFB still report there. The
  package ships no polyfill — `web-vitals` is a runtime dependency that your
  bundler inlines next to the SDK, which is why the stack named a
  `scout-<hash>.js` chunk. (B14-2082)
- **Errors thrown inside the SDK bundle are no longer counted as application
  errors.** An uncaught error whose top frame is in the SDK (or `web-vitals`)
  carries `error.origin: sdk` and `error.category: sdk_internal`, is reported
  once per distinct failure per page, and is excluded from `error.count`,
  `view.error.count` and `error_click` frustration detection. Every other
  error now carries `error.origin: app`. (B14-2082)
- **One failing instrumentation can no longer abort `Scout.initialize()`.**
...
[Unreleased]: https://github.com/base-14/scout-react/compare/v0.1.20...HEAD
[0.1.20]: https://github.com/base-14/scout-react/compare/v0.1.19...v0.1.20
[0.1.19]: https://github.com/base-14/scout-react/compare/v0.1.17...v0.1.19
[0.1.18]: https://github.com/base-14/scout-react/commit/8990d6eda2dea16faa8270f0dad4c7b54e92b78b
[0.1.17]: https://github.com/base-14/scout-react/compare/v0.1.16...v0.1.17
[0.1.16]: https://github.com/base-14/scout-react/compare/v0.1.15...v0.1.16
[0.1.15]: https://github.com/base-14/scout-react/compare/v0.1.14...v0.1.15
[0.1.14]: https://github.com/base-14/scout-react/compare/v0.1.13...v0.1.14
[0.1.13]: https://github.com/base-14/scout-react/compare/v0.1.12...v0.1.13
[0.1.12]: https://github.com/base-14/scout-react/compare/v0.1.11...v0.1.12
[0.1.11]: https://github.com/base-14/scout-react/compare/v0.1.10...v0.1.11
[0.1.10]: https://github.com/base-14/scout-react/compare/v0.1.9...v0.1.10
[0.1.9]: https://github.com/base-14/scout-react/compare/v0.1.8...v0.1.9
[0.1.8]: https://github.com/base-14/scout-react/compare/v0.1.7...v0.1.8
[0.1.6]: https://github.com/base-14/scout-react/compare/v0.1.5...v0.1.6
[0.1.1]: https://github.com/base-14/scout-react/releases/tag/v0.1.1
