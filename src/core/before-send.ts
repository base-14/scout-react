import type { Attributes, BeforeSendCallback, BeforeSendEvent, EventType, SeverityText, } from './types';
export function applyBeforeSend(cb: BeforeSendCallback | undefined, type: EventType, name: string, attributes: Attributes, opts?: {
